...
# cd into your javascript directory (if you have one)
# run: git clone git://github.com/vanntastic/qtip.git
# add the following to your page:

bc.. <link rel="stylesheet" href="qtip/qtip.css" type="text/css" media="screen">
